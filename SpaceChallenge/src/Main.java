...
public class Main {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        System.out.println("____Simulating Phase 1____Simulating Phase 1____Simulating Phase 1____");
        simulation.runSimulation(simulation.loadU1(phase1Item), 1);
        System.out.println("____Simulation Done____Simulation Done____Simulation Done____\n");
        phase1Rockets = U1.getRocketU1Counter();
        System.out.println("Rockets used for phase 1: " + phase1Rockets);

        System.out.println("____Simulating Phase 2____Simulating Phase 2____Simulating Phase 2____");
